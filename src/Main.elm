...
import DataUtils exposing (loadResource, parseQuote, parseJSON)
...
update msg model =
    case msg of
        ...
        QuotesLoaded lang content ->
            let
                internal = model.internal
                parsedQuotes = parseQuote content
...
loadQuotes lang =
    loadResource ("i18n/" ++ lang ++ "/quote.dsv") (handleQuotesResponse lang)
...
loadMessages lang =
    loadResource ("i18n/" ++ lang ++ "/system.json") (handleMessagesResponse lang)
